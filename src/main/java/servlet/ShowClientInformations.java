 ...
 * @author Admin
 */
@WebServlet(name = "ShowClientInformations", urlPatterns = {"/ShowClientInformations"})
public class ShowClientInformations extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            resultat.put("info", dao.showClientInList(code));
